...
alias figletscriptsmall='figlet -f smscript'
alias figletshadow='figlet -f shadow'
alias figletshadowsmall='figlet -f smshadow'
alias figletslant='figlet -f slant'
alias figletslantsmall='figlet -f smslant'
...
alias lolgroups='listgroups | lolcat'
